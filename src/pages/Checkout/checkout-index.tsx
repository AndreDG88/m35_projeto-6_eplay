...
import { getTotalPrice } from '../../utils/utils-index'
...
const Checkout = () => {
  ...
  //Função para que inputs com erro recebam uma borda vermelha.
      ...
      {isSuccess && data ? (
        ...
        <form onSubmit={form.handleSubmit}>
          <Card title="Dados de cobrança">
            {/* para a função Mask é necessário instalar a extensão "npm i --save react-input-mask" e "npm i --save-dev @types/react-input-mask" */}
            <>
              <S.Row>
                <S.InputGroup>
